 ...
 * O_RDWR	Open the file so that it can be read from and written 
to.
 ...
 */
#define FILE1 "demo-file1.txt" define FILE2 "demo-file2.txt" define 
#FILE3 "demo-file3.txt" include <stdio.h> include <sys/stat.h> include 
